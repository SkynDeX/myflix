...
// 실제 도서 이미지와 정보를 사용한 더미 데이터
const bookDatabase = [
  {
    title: '아몬드',
    author: '손원평',
    publisher: '창비',
    image: 'https://via.placeholder.com/300x400/4ECDC4/FFFFFF?text=아몬드',
  ...
  },
  {
    ...
    author: '히가시노 게이고',
    publisher: '현대문학',
    image: 'https://via.placeholder.com/300x400/45B7D1/FFFFFF?text=나미야잡화점',
  ...
  },
  {
    ...
    author: '매트 헤이그',
    publisher: '인플루엔셜',
    image: 'https://via.placeholder.com/300x400/96CEB4/FFFFFF?text=미드나잇',
  ...
  },
  {
    ...
    author: '김호연',
    publisher: '나무옆의자',
    image: 'https://via.placeholder.com/300x400/FFEAA7/FFFFFF?text=불편한편의점',
  ...
  },
  {
    ...
    author: '생텍쥐페리',
    publisher: '열린책들',
    image: 'https://via.placeholder.com/300x400/DDA0DD/FFFFFF?text=어린왕자',
  ...
  },
  {
    ...
    author: '헤르만 헤세',
    publisher: '민음사',
    image: 'https://via.placeholder.com/300x400/98D8C8/FFFFFF?text=데미안',
  ...
  },
  {
    ...
    author: '자청',
    publisher: '웅진지식하우스',
    image: 'https://via.placeholder.com/300x400/F7DC6F/FFFFFF?text=역행자',
  ...
  },
  {
    ...
    author: '게리 켈러',
    publisher: '비즈니스북스',
    image: 'https://via.placeholder.com/300x400/FF6B6B/FFFFFF?text=원씽',
  ...
  },
  {
    ...
    author: '채사장',
    publisher: '웨일북',
    image: 'https://via.placeholder.com/300x400/4ECDC4/FFFFFF?text=지적대화',
  ...
  },
  {
    ...
    author: '유발 하라리',
    publisher: '김영사',
    image: 'https://via.placeholder.com/300x400/45B7D1/FFFFFF?text=사피엔스',
  ...
  },
  {
    ...
    author: '칼 세이건',
    publisher: '사이언스북스',
    image: 'https://via.placeholder.com/300x400/96CEB4/FFFFFF?text=코스모스',
  ...
  },
  {
    ...
    author: '재레드 다이아몬드',
    publisher: '문학사상',
    image: 'https://via.placeholder.com/300x400/FFEAA7/FFFFFF?text=총균쇠',
  ...
  },
  {
    ...
    author: 'J.D. 샐린저',
    publisher: '민음사',
    image: 'https://via.placeholder.com/300x400/DDA0DD/FFFFFF?text=호밀밭',
  ...
  },
  {
    ...
    author: '조지 오웰',
    publisher: '민음사',
    image: 'https://via.placeholder.com/300x400/98D8C8/FFFFFF?text=1984',
  ...
  },
  {
    ...
    author: 'N.H. 클라인바움',
    publisher: '서교출판사',
    image: 'https://via.placeholder.com/300x400/F7DC6F/FFFFFF?text=죽은시인',
...
export const searchBooks = async (query, display = 20, start = 1) => {
  try {
    // 실제 API 호출 코드 (CORS 문제로 주석 처리)
    /*
    const response = await axios.get('/api/naver/book', {
      headers: {
    ...
    return filterValidBooks(response.data.items);
    */
    ...
    // 에러 시에도 더미 데이터 반환
    return generateDummyBooks(query, display);
  }
};
...
export const getBestsellerBooks = async (categoryId = 100) => {
  try {
    ...
    const books = generateDummyBooks(categoryNames[categoryId] || '베스트셀러', 20);
    return filterValidBooks(books);
  } catch (error) {
