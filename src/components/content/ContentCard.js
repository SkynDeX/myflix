...
const ContentCard = ({ content, type }) => {
  ...
  console.log('ContentCard 렌더링:', { content, type });
  ...
  const getContentImage = () => {
    if (type === 'movie') {
      if (content.poster_path) {
        ...
        return 'https://via.placeholder.com/300x450/FF6B6B/FFFFFF?text=Movie';
      }
    }
    return content.image || 'https://via.placeholder.com/300x400/4ECDC4/FFFFFF?text=Book';
  };
